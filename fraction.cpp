...
// To subtract fraction from a number
Fraction Fraction::operator-(int integer) const{

  // Converting integer to fraction
	Fraction fraction;
	fraction.set(integer);

  // Subtracting new fraction from this fraction 
	return *this - fraction;
}

// Implementing the non-member subtraction function
